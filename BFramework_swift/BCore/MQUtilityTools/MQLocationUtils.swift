...
typealias MQCheckLocation = (MQCheckLocationStatus,CLLocation?) -> Void
private let shareLocation = MQLocationUtils()

class MQLocationUtils: NSObject,CLLocationManagerDelegate {
    
    private var checkEnd: MQCheckLocation?
    var located:  Bool = false
    var locating: Bool = false
    var manager:  CLLocationManager?
    
    class var shareInstance: MQLocationUtils {
    ...
    func checkCurrentLocation(completion:MQCheckLocation?) -> Void {
