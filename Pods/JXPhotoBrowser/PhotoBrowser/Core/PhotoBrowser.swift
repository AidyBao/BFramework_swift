...
open class PhotoBrowser: UIViewController {
    ...
    /// 转场协调器
    weak var fadePresentationController: PhotoBrowserPresentationController?

    /// 缩放型转场协调器
    weak var scalePresentationController: ScalePresentationController?
...
extension PhotoBrowser: UIViewControllerTransitioningDelegate {
    ...
    public func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        ...
        case .scale:
            ...
            fadePresentationController = controller as PhotoBrowserPresentationController
