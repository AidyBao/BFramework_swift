...
class MQDevice: NSObject {
    ...
    //MARK:- 获取手机UUID
    class func mq_deviceUUID() ->String {
        return (UIDevice.current.identifierForVendor?.uuidString)!
    }
    
    //MARK:- 获取手机系统版本
    class func mq_deviceVersion() ->String {
        return UIDevice.current.systemVersion
    }
    
    //MARK:- 手机系统
    class func mq_deviceSystem() ->String {
        return UIDevice.current.systemName
    }
    
    //MARK:- 手机类型
    class func mq_deviceType() ->String {
